...
# OG AI Website - Google Cloud Run Deployment (Artifact Registry)
# Adapted to match google cloud configuration used in deploy-yantrai-website.sh
...
SERVICE_NAME="ask-anything-cctv"
IMAGE_NAME="ask-anything-cctv"
IMAGE_TAG="latest"

# Derived
FULL_IMAGE_NAME="$REGION-docker.pkg.dev/$PROJECT_ID/$REPO/$IMAGE_NAME:$IMAGE_TAG"

echo -e "${BLUE}🚀 Starting OG website deployment to Cloud Run${NC}"
